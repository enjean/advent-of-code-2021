...
internal class SubLocationTest {
    ...
    inner class ApplyCommand {
        ...
        fun `forward 5 adds 5 to your horizontal position`() {
            ...
            assertEquals(result, SubLocation(horizontalPosition = 5, depth = 0))
        }
        ...
        fun `down 5 adds 5 to your depth`() {
            ...
            assertEquals(result, SubLocation(horizontalPosition = 5, depth = 5))
        }
        ...
        fun `forward 8 adds 8 to your horizontal position`() {
            ...
            assertEquals(result, SubLocation(horizontalPosition = 13, depth = 5))
        }
        ...
        fun `up 3 decreases your depth by 3`() {
            ...
            assertEquals(result, SubLocation(horizontalPosition = 13, depth = 2))
        }
        ...
        fun `down 8 adds 8 to your depth`() {
            ...
            assertEquals(result, SubLocation(horizontalPosition = 13, depth = 10))
        }
        ...
        fun `forward 2 adds 2 to your horizontal position`() {
            ...
            assertEquals(result, SubLocation(horizontalPosition = 15, depth = 10))
        }
    }
}